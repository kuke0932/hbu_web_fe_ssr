<template>
  <div class="container register">
    <div class="registerForm" style="background: #ffffff; padding-bottom: 10px;">
      <mt-field label="标题" placeholder="请输入标题" v-model="title"></mt-field>
      <mt-field label="内容" type="textarea" rows="2" placeholder="请输入意见内容" v-model="content"></mt-field>
      <mt-field label="标题" placeholder="请输入标题" v-model="title"></mt-field>
      <div class="uploadRow">
      ...
      <mt-field label="价格" placeholder="请输入价格" v-model="price"></mt-field>
    </div>
    <div class="bigImg" @click="hideBigImg" v-if="showBigImg">
    </div>
    ...
    <div class="buttons">
      <mt-button style="width: 100%;" type="primary" @click="saves">发布</mt-button>
    </div>
  </div>
</template>
